        ...
        <main>
          ...
          <div class="row g-5">
            <div class="col-md-5 col-lg-4 order-md-last">
              <h4 class="d-flex justify-content-between align-items-center mb-3"><span class="text-primary">구입목록</span>
            ...
            <div class="col-md-7 col-lg-8">
              ...
              <div class="needs-validation" novalidate="">
                ...
                <label for="cc-name" class="form-label">카드번호</label><input type="text" class="form-control" id="cc-name"
                  placeholder="카드번호를 입력해주세요" v-model="state.form.cardNumber">
